...
class C_admin_produk extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model(array('M_produk','M_kat_produk','M_satuan','M_ukuran'));
	}
	...
	public function index()
	{
		...
		else
		{
			...
			if(!empty($cek_ses_login))
			{
				...
				$list_ukuran = $this->M_ukuran->list_ukuran_produk('');
				$list_produk = $this->M_produk->list_produk_limit($cari,$config['per_page'],$this->uri->segment(2,0));
				$data = array('page_content'=>'admin_produk','halaman'=>$halaman,'list_produk'=>$list_produk,
				'list_kat_produk'=>$list_kat_produk,'list_satuan'=>$list_satuan,'list_ukuran'=>$list_ukuran);
	...
	public function list_ukuran_produk()
	{
		$id_kat_produk =  $_POST['kode'];
		
		$list_ukuran = $this->M_ukuran->list_ukuran_produk($id_kat_produk);
